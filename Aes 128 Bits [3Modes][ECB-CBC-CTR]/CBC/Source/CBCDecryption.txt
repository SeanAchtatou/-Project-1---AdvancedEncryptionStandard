...
print("####################################################################### AES 128 BLOCK CIPHER DECRYPTION ##################################################################################### ")
def AESBLOCKCIPHER2_INV(matrix1, matrixmainkey, matrixexpansion):
####################################################### INVERSE LAST ROUND WITHOUT MIXCOLUMNS ##########################
    print("")
    print("-------------------------------------------------- LAST ROUND INVERSE -----------------------------------------------")
    ...
    Q1 = matrix1[0][1]
    matrix1[0][1] = matrix1[3][1]
    Q2 = matrix1[0][2]
    matrix1[0][2] = matrix1[2][2]
    Q3 = matrix1[0][3]
    matrix1[0][3] = matrix1[1][3]
    ...
    matrix1[1][3] = matrix1[2][3]

    matrix1[2][0] = matrix1[2][0]
    Q6 = matrix1[2][1]
    matrix1[2][1] = Q5
    matrix1[2][2] = Q2
    matrix1[2][3] = matrix1[3][3]
...
###################################### INVERSE ROUNDS [HERE 10 ROUNDS WILL BE DONE WITH 128 BITS KEY ###################
    print("")
    print(
        "----------------------------------------ALL THE INVERSE ROUNDS FROM 1 TO 9---------------------------------------------")
    q = -1
    h = 9
    for round in range(0, 9):  # Here will be the main instruction in the AES with the differents functions
        ...
        w = 0
        for i in matrix1:
            matrix1[w][0] = Mul14[i[0]] ^ Mul11[i[1]] ^ Mul13[i[2]] ^ Mul9[i[3]]
            matrix1[w][1] = Mul9[i[0]] ^ Mul14[i[1]] ^ Mul11[i[2]] ^ Mul13[i[3]]
            matrix1[w][2] = Mul13[i[0]] ^ Mul9[i[1]] ^ Mul14[i[2]] ^ Mul11[i[3]]
            matrix1[w][3] = Mul11[i[0]] ^ Mul13[i[1]] ^ Mul9[i[2]] ^ Mul14[i[3]]
            w += 1
        print("")
        print("MixColumns :")
        print(matrix1)
...
################################################# INITIAL ROUND INVERSE [ADDROUNDKEY] ##########################################
    print("")
    print(
    "----------------------------------------------- INITAL ROUND INVERSE -----------------------------------------------------")
    o = -1
    for i in matrix1:
        o += 1
        c = 0
